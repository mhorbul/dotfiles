...

;;;### (autoloads nil "starter-kit" "starter-kit.el" (20336 50519))
;;; Generated autoloads from starter-kit.el

(dolist (mode '(menu-bar-mode scroll-bar-mode)) (when (fboundp mode) (funcall mode -1)))
...
;;;;;;  "starter-kit-pkg.el") (20336 50519 463329))
